...
public class D5_001_DDT_CSV {
	...
	public void tc_shoppingCartTesting() throws InterruptedException, IOException{
		...
		String csvTestDataFilePath ="C:\\SeleniumJAVATraining\\testdata\\csvfiles\\ShoppingCartTestData.csv";
		String resultsToCSV ="C:\\SeleniumJAVATraining\\testdata\\csvfiles\\ShoppingCartTestDataRESULTS.csv";
        ...
        boolean isFileExist = new File(csvOutputFile).exists();
            try {
             ...
             //add record to the file
                testData.write("1234");
                testData.write("Login");
                testData.write("Dashboard");
