	...
	*/
	...
	public static WebDriver OpenBrowser(String RunTestInBrowser, String AUT_URL)
	{
		...
		if (RunTestInBrowser.equals("IE"))
		{
		        ...
		        BrowserDriverLocation = "C:\\SeleniumJAVATraining\\Softwares\\IEDriverServer\\32bit\\IEDriverServer.exe";
		...
		{
			BrowserToRun = "webdriver.firefox.marionette";
	        BrowserDriverLocation = "C:\\SeleniumJAVATraining\\Softwares\\GeckoDriver\\64bit\\geckodriver.exe";
	        System.setProperty(BrowserToRun, BrowserDriverLocation);
